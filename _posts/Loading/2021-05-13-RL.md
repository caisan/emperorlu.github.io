...
- 增量迁移
  ...
  - 增加OSD节点（Agent2）
    ...
    - **action：{0，1，2，3}**
      ...
      - PGi —> (OSDk, OSDj, OSDl)，0表示从OSDk迁移到新节点，1、2类同
      - 3表示不迁
    ...
    - Reward：各osd容量标准差的根号
      ...
      ![image-20210526182639889](..\..\photos\RL\image-20210526182639889.png)
...
- 负载分析
  ...
  - 性能热点测试
    ...
    ![021800a034-fig-3-source-small](C:\lukai1\桌面\商汤实习\Blog\emperorlu.github.io\photos\Load\021800a034-fig-3-source-small.gif)
...
- 问题抽象
  ...
  - 当我们寻求最小化执行时间r(P)时，对r(P)的直接优化会导致两个主要问题。首先，在训练过程的开始，由于不好的位置采样，r(P)的测量可能是有噪声的，导致不适当的学习信号

  - 其次，随着RL模型的逐渐收敛，被采样的位置变得更加相似，相应的运行时间之间的差异较小，导致训练信号的可分辨性较差。

    ![image-20210526171831851](..\..\photos\RL\image-20210526171831851.png)
